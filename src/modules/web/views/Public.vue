  ...
  formulate-form(
    ...
    section.public-whoWeAre
      ...
      .public-whoWeAre__content
        .text-item(v-for="(item,index) in publicWebForm.aboutUsFeaturesIcons" :key="`feature-${index}`")
          formulate-input(
            type="group"
            name="aboutUs"
          )
...
export default class Public extends Vue {
  ...
  publicWebForm = {
    ...
    impactData: [] as Section.ImpactData[],
      ...
      properties: {
        ...
        whyChooseUs: {
          ...
          design: {
            ...
            backgroundImage: this.publicWebForm.whyChooseUsDesignBackgroungImage
          }
        },
